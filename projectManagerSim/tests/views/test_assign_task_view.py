...
class AssignTaskViewTestCase(TestCase):
    ...
    def test_assign_task_success(self):
        ...
        self.assertEqual(self.save_character.task_assigned, self.task)

    def test_missing_task_or_character_id(self):
    ...
    def test_save_character_not_allowed(self):
        ...
        self.assertFalse(response.json()["success"])
        self.assertEqual(response.json()["message"], "Not allowed to assign this task")
